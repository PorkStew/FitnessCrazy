...
TextView date, weights;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contactDbHelper.CreateUserLogWeight(database);
        contactDbHelper.getUserInformationWeightLogs(database);
...
String weightss = "";
  ...
  while(iloop< ContactContact.ContactEntry.NumberOfEntries)
  {
      ...
      weightss = weightss + ContactContact.ContactEntry.getWeightArray() [iloop] + "\n";
      iloop++;
  }
date.setText(dates);
weights.setText(weightss);
        ...
        Binsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                contactDbHelper.addUserWeightLog(Weight, database);
